package id.sadhaka.myapplication;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNew = (Button) findViewById(R.id.btn_tambah);
        btnOpen = (Button) findViewById(R.id.btn_buka);
        btnSave = (Button) findViewById(R.id.btn_simpan);
        editContent = (EditText) findViewById(R.id.edit_isi);
        editTitle = (EditText) findViewById(R.id.edit_judul);
